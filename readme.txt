...
> Looking for more functionality? We recommend the all new [WP Rich Snippets](http://authorhreview.com/plugins/wp-rich-snippets/) plugin, more schema.org types plus awesome [add-on plugins](http://authorhreview.com/addons/) that extends the WP Rich Snippets pluginÕs functionality. View the [plugin documentation](http://authorhreview.com/documentation/) pages and [Showcase Gallery](http://authorhreview.com/showcase/).
...
= 0.0.9.5 =
Fixed a markup error based on the new updated Google Structured Data Testing Tool. Please upgrade now to solve the broken markup issue.