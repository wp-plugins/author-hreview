...
$meta_box = array(
	...
	'fields' => array(
		...
		array(
			'name' => 'Select Rating (our of 5)',
			'id' => $prefix . 'review_rating',
			'type' => 'select',
			'options' => array('', '1 Star', '2 Stars', '3 Stars', '4 Stars', '5 Stars'),
			'std' => ''
		),
	)
);
...
function ta_mytheme_post_add_box() {
	...
	add_meta_box($meta_box['id'], $meta_box['title'], 'ta_mytheme_post_show_box', $meta_box['page'], $meta_box['context'], $meta_box['priority']);
}
