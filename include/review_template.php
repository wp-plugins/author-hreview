...
<!-- Start Of Script Generated by Author hReview Plugin 0.0.7.4 by authorhreview.com -->
...
*/ ?>
<!-- End Of Script Generated by Author hReview Plugin 0.0.7.4 by authorhreview.com -->
	...
	if ( is_home() || is_archive() ) {
		...
		if (isset($custom["ta_post_review_rating"]) == null) {
			...
			if ($rating) { // if it's a review, then show the stars
				...
				$content = '	<p class="ar_headline_meta_home">
								<span class="ar_rating_home ar_result_home ar_rating_home_span">
									<span class="ar_result_home" style="width:' . $rating_star . '%;" title="' . $rating . '"></span>
								</span>
								</p>
								' . $content;
			}
